...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        gradientBlueStart: "rgba(51, 117, 246, 0.32)",
        gradientBlueEnd: "rgba(51, 117, 246, 0.052)",
        gradientStart: "rgba(234, 86, 56, 0.32)",
        gradientEnd: "rgba(234, 86, 56, 0.052)",
        borderMonth: "rgba(234, 86, 56, 1)",
        backroundTwo: "rgba(20, 23, 31, 1)",
      },
      animation: {
      ...
      backgroundImage: {
          "custom-orange1":
          "linear-gradient(-20deg, rgba(20, 23, 31, 1) 76%, rgba(234, 86, 56, 0.4))",
          "custom-blue":
          "linear-gradient(-25deg, rgba(20, 23, 31, 1) 80%, rgba(51, 117, 246, 0.4))",
        "custom-radial":
        ...
        "order-hover":
          "linear-gradient(45deg, #3375F6 -40%, #02005E,transparent)",
