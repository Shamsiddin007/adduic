...
function page() {
  return (
    <div className="container">
      <div className="bg-slate-900 flex flex-col items-center h-[500px] justify-center">
          ...
          <p className="text-gray-500 text-center w-[779px] pt-4">We provide comprehensive development solutions focused on creating engaging, interactive experiences that enhance user engagement, learning, and entertainment across a variety of platforms and applications</p>

      </div>
      <div className="grid grid-cols-2 grid-rows-3 gap-6 mt-12">
