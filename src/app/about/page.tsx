    ...
    <div>
      ...
      >
        <div className="flex flex-col items-center justify-center h-full pt-32 md:pt-56 px-4 md:px-0 pb-36">
          <span className="flex gap-2 items-center bg-[#202123] w-full max-w-[380px] rounded-full text-white text-xs md:text-sm py-2 px-3 font-sans mb-4 md:mb-7">
            <Image
              src={Fire}
              alt="FireLogo"
          ...
          <p className="text-gray-500 text-center max-w-[90%] md:max-w-[800px] lg:max-w-[1184px] pt-4 md:pt-8 text-sm md:text-base">
            ...
            adventures and compelling narratives. <br />
            Our team of talented developers, designers, and creatives come
            together to push the boundaries of what is possible, delivering
      ...
      <div className="container text-white">
        <div className="mt-20 flex flex-col gap-9 items-center">
          <p className="text-xl text-gray-500">How do we work?</p>
          <h2 className="font-bold text-4xl md:text-6xl text-white uppercase text-center">
        ...
        <div className="part2-about">
          <div className="about-child cursor-pointer group transition-all  hover:bg-[linear-gradient(-330deg,_#0a2346_12%,_transparent_90%,_#3375F60A_99%)] duration-1000 ease-in-out">
            <div className="about-child-circle flex items-center justify-center relative z-1">
              <svg
                ...
                className="group-hover:stroke-blue-600 transition duration-1000"
              >
                <path
            ...
            <h1 className="text-[24px] pb-2"> Innovation</h1>
          ...
          <div className="about-child cursor-pointer group hover:bg-[linear-gradient(-330deg,_#0a2346_12%,_transparent_90%,_#3375F60A_99%)]">
            ...
            <h1 className="text-[24px] pb-2"> Passion</h1>
            <p className="text-[#FFFFFF66] text-sm text-center">
              Our love for gaming drives everything we do. We pour our hearts
              into each project, ensuring every detail reflects our dedication
              to the craft.
            </p>
          </div>
          <div className="about-child cursor-pointer group hover:bg-[linear-gradient(-330deg,_#0a2346_12%,_transparent_90%,_#3375F60A_99%)]">
            ...
            <h1 className="text-[24px] pb-2"> Collaboration</h1>
            <p className="text-[#FFFFFF66] text-sm text-center">
              We believe in the power of teamwork. Our team works through
              combining unique perspectives to create something extraordinary.
            </p>
          </div>
          <div className="about-child cursor-pointer group hover:bg-[linear-gradient(-330deg,_#0a2346_12%,_transparent_90%,_#3375F60A_99%)]">
            <div className="about-child-circle flex items-center justify-center relative z-1">
            ...
            <h1 className="text-[24px] pb-2"> Quality</h1>
            <p className="text-[#FFFFFF66] text-sm text-center">
              Excellence is our standard. We are committed to delivering
              polished, high-quality games that exceed player expectations.
            </p>
          </div>
          <div className="about-child cursor-pointer group hover:bg-[linear-gradient(-330deg,_#0a2346_12%,_transparent_90%,_#3375F60A_99%)]">
            <div className="about-child-circle flex items-center justify-center relative z-1">
            ...
            <h1 className="text-[24px] pb-2"> Creativity</h1>
            <p className="text-[#FFFFFF66] text-sm text-center">
              We embrace bold ideas and encourage out-of-the-box thinking,
              fostering a culture where imagination thrives.
            </p>
          </div>
          <div className="about-child cursor-pointer group hover:bg-[linear-gradient(-330deg,_#0a2346_12%,_transparent_90%,_#3375F60A_99%)]">
            <div className="about-child-circle flex items-center justify-center relative z-1">
            ...
            <h1 className="text-[24px] pb-2"> Growth</h1>
            <p className="text-[#FFFFFF66] text-sm text-center">
              We are committed to continuous learning and improvement, always
              seeking new ways to enhance our skills and evolve with the
              industry.
            </p>
          </div>
        </div>
        <div className="part3-about">
          <div>
            ...
            <p className="paragraph">
              Our company provides a broad spectrum of services in the field of
              game development and provides a learning ground for any talented
              youth willing to conquer the game industry.
            </p>
          ...
          <div className="card">
            <Image src={Game1} alt="" className="card-image" />
            <div className="icon">
              <Image src={Game} alt="" />
            </div>
            <h1 className="card-title">Game development</h1>
