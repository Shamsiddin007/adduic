            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-8">
                <ul className="space-y-3">
                  <li>
                    <Link href="/portfolio" className="text-gray-400">
                      Our projects
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="/praktikum" className="text-gray-400">
                      The team
                    </Link>
                  </li>
                </ul>
                <ul className="space-y-3">
                  <li>
                    <Link href="/service-us" className="text-gray-400">
                      Contact us
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="/blog" className="text-gray-400 item6">
                      Results
                    </Link>
                  </li>
                </ul>
