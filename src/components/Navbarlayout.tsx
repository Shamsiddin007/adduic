...
import Link from "next/link";
import { useEffect, useState } from "react";
import { usePathname } from "next/navigation"; // Next.js'da `useRouter` o'rniga `usePathname` ishlatamiz
import styles from "./style.module.css";
import Logo from "/public/icons/Logo.svg";
import BurgerIcon from "/public/Imgs/hamburger_icon.svg";
import CloseBtn from "/public/Imgs/close-428 1.png";
...
const Navbarlayout = () => {
  ...
  // Sahifani yangilaganda aktiv yo'nalishni localStorage'dan olish
  useEffect(() => {
