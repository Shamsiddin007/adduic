  ...
  return (
    <div className="container mx-auto max-w-screen-xl mb-8">
      ...
      <div className="flex gap-[40px]">
        <div className="cursor-pointer relative w-[281px] h-96 overflow-hidden rounded-[24px] flex flex-col items-center bg-gradient-to-b from-black to-gray-800 rounded-2xl p-5 text-white text-center shadow-md shadow-black/50 group">
        ...
        <div className="relative w-[281px] h-96 overflow-hidden rounded-lg shadow-md shadow-black/50 p-6 text-center text-white group">
          <div
