  ...
  return (
    <div className="container select-none mx-auto">
      <div className="h-[max-content] w-full text-white pb-[450px] pt-20 mb-10">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl capitalize mt-8 text-center flex items-center justify-center gap-6 md:mb-8">
          work <span className="text-[#3375F6]">opportunities</span>
        </h1>
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 md:grid-cols-1 lg:w-full md:w-[400px] md:m-auto gap-8 mt-20">
            {trips.map((job) => (
              <div
                key={job.id}
