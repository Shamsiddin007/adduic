...
//                     <div className="group relative w-full rounded-2x p-5 text-white shadow-lg transition-all duration-300 hover:shadow-xl mb-12">
                  ...
                  >
                    <Link href={`/portfolio/${project.id}`}>
                      <div className="group relative w-full rounded-2x p-5 text-white shadow-lg transition-all duration-300 hover:shadow-xl mb-12">
                        ...
                        <p className="text-gray-300 pb-14">
                          {project.date}
                        </p>
                        <div className="flex-grow relative w-full">
                          <img
